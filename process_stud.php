...
$time = date ("h:i:s A");
session_start();
if ((isset($_SESSION['hasVoted_stud']))) {
	if ($_SESSION['hasVoted_stud'] = '1') {
		@include("INDEX.php");
	print '<div class="messages_stud">You Have Already Voted!</div>';
	;goto a;
	}
}
	...
	print '<div class="messages_stud">You didn\'t select a voting option!</div>';
